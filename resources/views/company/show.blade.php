...
@section('mainTitle')
    Muat Turun Data : Maklumat Terperinci {{ $certificate->name }}
@endsection
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <div class="col-md-12">
                ...
                <br>
                <a href="/company-download/download/{{ $certificate->id }}" class="btn btn-primary btn-block">Muat Turun Rekod</a>
