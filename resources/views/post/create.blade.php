...
@section('mainTitle')
    Kemaskini Maklumat Pembungkusan : {{ $certificate->ic_number }}
@endsection
            ...
            <form class="form-horizontal" role="form" method="POST">
               ...
               <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                ...
                <div v-if="mypost == 'Y'" class="form-group{{ $errors->has('date_receive') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <input name="date_receive" type="date" class="form-control" value="{{ old('date_receive') }}">
                ...
                {{--<div class="form-group{{ $errors->has('source') ? ' has-error' : '' }}">--}}
                    ...
                    {{--<div class="col-md-6">--}}
                        {{--<select name="source" class="form-control">--}}
                            ...
                            {{--<option  value="syarikat">Syarikat Luar</option>--}}
                        {{--</select>--}}
