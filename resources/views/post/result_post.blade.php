...
@section('mainTitle')
    Kemaskini Maklumat Pengeposan Oleh Dalaman Mengikut Batch ID
@endsection
                    ...
                    @else
                        ...
                        @foreach($certificates as $certificate)
                            <tr>
                                ...
                                <td>{{ $totalstudent = \App\Certificate::where('batch_id',$certificate->batch_id)->where('flag_printed', 'Y')->where('source', 'dalaman') ->groupBy('batch_id')->count()}}</td>
