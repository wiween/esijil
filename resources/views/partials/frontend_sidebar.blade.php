...
@if (Auth::user()->access_power == 500 || Auth::user()->access_power >= 5000 )
    ...
    <li @if (Request::segment(1) == 'company-print') class="active" @endif>
        <a href="/company-print/search"><i class="icon-printer4"></i> <span>Percetakan</span></a>
        <ul>
            <li><a href="/company-print/search">Cetakan Baru</a></li>
        </ul>
        <ul>
            <li><a href="/company-print/search-edit">Edit Sijil</a></li>
        </ul>
    </li>
    <li @if (Request::segment(1) == 'company-search') class="active" @endif>
        <a href="/company-search/post"><i class="icon-mail-read"></i> <span>Pengeposan</span></a>
        <ul>
            <li><a href="/company-search/post">Pos Baru</a></li>
            <li><a href="/company-search/list">Selesai Pengeposan</a></li>
        </ul>
    </li>
...
@if (Auth::user()->role == 'super_admin')
    ...
    <li @if (Request::segment(2) == 'audit-trail') class="active" @endif><a href="/audit-trail">
    ...
    <li @if (Request::segment(2) == 'lookups') class="active" @endif>
        ...
        <ul>
            <li><a href="/lookups/role">Role</a></li>
        </ul>
