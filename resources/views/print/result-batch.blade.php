                                ...
                                <ul class="icons-list">
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <li><a href="{{ url('') }}/print/list/{{ $certificate->batch_id }}"><i class="icon-display text-primary"></i>Lihat Senarai</a></li>
                                            {{--<li><a href="/company-download/download/{{ $certificate->batch_id }}"><i class="icon-download10 text-primary"></i>Muat Turun</a></li>--}}
                                            <li><a href="{{ url('') }}/print/printed/{{ $certificate->batch_id }}/{{ $certificate->type }}"><i class="icon-database-edit2 text-primary"></i>Kemaskini Percetakan</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </td>
