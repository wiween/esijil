...
@section('mainTitle')
    Pengesahan Oleh Jawatakuasa Penilaian Persijilan : Senarai Pelajar Batch Ditolak {{ Request::segment(3) }}
@endsection
                                    ...
                                    <ul class="icons-list">
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <li><a href="{{ url('') }}/board/set-flag/K/{{ $espkm->id }}"><i class="icon-flag7 text-black-600"></i>KIV</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </td>
