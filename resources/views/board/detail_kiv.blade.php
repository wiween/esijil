...
@section('mainTitle')
    Pengesahan Oleh Jawatakuasa Penilaian Persijilan : Senarai Pelajar Batch KIV {{ Request::segment(3) }}
@endsection
                                    ...
                                    <ul class="icons-list">
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <li><a href="{{ url('') }}/board/set-flag/R/{{ $espkm->id }}"><i class="icon-flag7 text-black-600"></i>Tidak Disahkan</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </td>
