                ...
                <div class="col-md-12 table-responsive">
                    <table class="table">
                        ...
                        @foreach ($replacements as $replacement)
                            <tr>
                                <td>{{ $loop->index + 1 }}</td>
                                <td><a href="{{ url('') }}/replacement/show-after/{{ $replacement->certificate_id }}/{{ $replacement->id }}">{{ $replacement->certificate->name }}</a> </td>
                                    ...
                                    <ul class="icons-list">
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                <li><a href="{{ url('') }}/replacement/show-after/{{ $replacement->certificate_id }}/{{ $replacement->id }}"><i class="icon-display"></i>Lihat & Edit</a></li>
                                                ...
                                                <li><a href="{{ url('') }}/replacement/flag/N/{{ $replacement->id }}"><i class="icon-trash text-danger-600"></i>Batalkan Permohonan</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </td>
