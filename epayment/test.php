	<form method="post" action="http://mohrwallet.mohr.gov.my/vip/vip.aspx">
...
<input type="text" name="RAMOUNT" value="100.00"><br>
...
<input type="submit" name="hantar" value="submit"><br>
</form>
